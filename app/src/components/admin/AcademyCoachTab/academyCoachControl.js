...
const AcademyCoachControl = ({ academy, select }) => {
    ...
    const handleDeleteAcademyCoach = (item) => {
        GameService.deleteAcademyCoach(item.user_id, academy.id).then((res) => {
    ...
    console.log('academy coach =>', academyCoachList, academies);
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', border: '1px solid #E8E8E8', borderRadius: '8px', width: '240px', height: '70vh', padding: '16px 12px' }}>
                ...
                {loading ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', maxHeight: '55vh', overflowY: 'auto' }}>
                        {academyCoachList.map((item, index) => (
                            <div
                                key={index}
                                style={{
                                    display: 'flex',
                            ...
                            >
                                ...
                                {selectedIndex === index && (
                                    <IconButton onClick={() => handleDeleteAcademyCoach(item)}>
                                        <DeleteIcon />
                                    </IconButton>
                                )}
                            </div>
...
export default AcademyCoachControl;
