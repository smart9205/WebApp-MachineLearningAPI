    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="2000px" maxheight="initial">
            ...
            <DialogContent style={{ display: 'flex', margin: '0 200px', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '32px', paddingBottom: '42px' }}>
                <Typography sx={{ fontFamily: "'DM Sans', sans-serif", fontSize: '30px', fontWeight: 700, color: '#1a1b1d' }}>Edit Game</Typography>
                <UploadButton
                ...
                <FormControlLabel
                    ...
                    label="Mute Video"
                />
                <SaveButton disabled={values.image === game.image && values.mute === game.mute_video} onClick={saveChanges} sx={{ width: '300px', fontSize: '16px' }}>
                    Save changes
                </SaveButton>
