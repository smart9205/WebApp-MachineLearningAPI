...
const CreateEditDialog = ({ open, handleEditOpen, teamList }) => {
    ...
    return (
        <>
            ...
            >
                <DialogTitle>Create NewEdit</DialogTitle>
                <DialogContent>
                    ...
                    <Box sx={{ display: "flex", gap: 1 }}>
                        <FormControl fullWidth>
                            ...
                            <Select
                                ...
                                input={<OutlinedInput id="select-multiple-action" label='Action' />}
                                renderValue={(selected) => (
                                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                                        {selected.map((value, idx) => (
                        ...
                        <FormControl fullWidth>
                            ...
                            <Select
                                ...
                                input={<OutlinedInput id="select-multiple-actiontype" label='ActionType' />}
                                renderValue={(selected) => (
                                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                                        {selected.map((value, idx) => (
                                            <Chip key={idx} label={value?.name} />
                        ...
                        <FormControl fullWidth>
                            ...
                            <Select
                                ...
                                input={<OutlinedInput id="select-multiple-action" label='ActionResult' />}
                                renderValue={(selected) => (
                                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                                        {selected.map((value, idx) => (
                                            <Chip key={idx} label={value?.name} />
                ...
                <DialogActions>
                    <Button onClick={() => handleEditOpen(false)}>Close</Button>
