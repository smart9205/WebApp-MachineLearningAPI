...
const LeadersPlayerStatItem = ({ player, option, isTotal }) => {
    return (
        <div style={{ display: 'flex', alignItems: 'center', width: '100%', height: '120px', padding: '16px 8px', justifyContent: 'space-between' }}>
