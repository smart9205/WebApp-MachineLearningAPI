...
const AIR_CHALLENGE = 'Air Challenge';
const GROUND_CHALLENGE = 'Ground Challenge';
...
export default function Pass({ defenseTeam, offenseTeam, taggingState, defenseTeamId, offenseTeamId,defenseTeamGoalKeeper }) {
    ...
    const defensivePlayerClickedDeflectedBy = (player) => {
        setDefensivePlayer(player);
        taggingState([
            {
                ...tagData,
        ...
        <>
            ...
            <SubBox>
                <List header="Result">
                    {[
                        ...
                        { id: 15, name: OFFSIDE },
                        { id: 9, name: ASSIST },
                        { id: 19, name: DEFLECTED_BY },
                        { id: 18, name: AIR_CHALLENGE },
                        { id: 8, name: GROUND_CHALLENGE }
                    ].map((r, i) => (
                        <ListItemButton
                            key={r.id}
            ...
            {result.name === DEFLECTED_BY && (
                <PlayerSelector
                    ...
                    selected={defensivePlayer}
                    onSelect={(player) => {
                        defensivePlayerClickedDeflectedBy(player);
                    }}
                />
            )}

            {result.name === AIR_CHALLENGE && (
                <PlayerSelector
                    title="Defensive Player List"
