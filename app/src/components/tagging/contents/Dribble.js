...
export default function Dribble({ defenseTeam, offenseTeam, taggingState, offenseTeamId, defenseTeamId, defenseTeamGoalKeeper }) {
                ...
                <List header="Result">
                    {RESULT_LIST.map((r, i) => (
                        <ListItemButton
                            ...
                            onClick={() => {
                                setResult(r);
                                if (r.name !== 'Draw Foul' && r.name !== 'Stolen By' && r.name !== 'Deflected By' && r.name !== 'Ground Challenge')
                                    taggingState([
                                        {
                    ...
                    <SubBox>
                        <List header="Foul Type">
                            {[
                                ...
                                <ListItemButton key={i} selected={foulTypeId === type.id} onClick={() => setFoulTypeId(type.id)}>
                                    <ListItemText primary={type.name} />
                                </ListItemButton>
                            ))}
                        </List>
