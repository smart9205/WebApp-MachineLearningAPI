...
export default function Shot({ defenseTeam, offenseTeam, taggingState, offenseTeamId, defenseTeamId, defenseTeamGoalKeeper }) {
    ...
    return (
        <>
            ...
            <PlayerSelector title="List of Players" playerList={offenseTeam} editable={false} selected={offensivePlayer} onSelect={(player) => setOffensivePlayer(player)} />
            <SubBox>
                <List header="Type">
                    {[
                        { id: 1, name: 'Right' },
            ...
            <SubBox>
                <List header="On Target">
                    {['Yes', 'No'].map((t, i) => (
                        <ListItemButton key={i} selected={onTarget === t} onClick={() => targetClicked(t)}>
            ...
            {goal === 'Yes' && (
                <PlayerSelector
                    title="Defensive Goalkeeper List"
