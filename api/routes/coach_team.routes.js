...
module.exports = (app) => {
  ...
  app.get(
    "/coach_team/getAllLeaguesByCoach/:userId",
    controller.getAllLeaguesByCoach
  );

  app.get(
    "/coach_team/getAllTeamsByCoach/:userId",
    controller.getAllTeamsByCoach
  );

  app.get(
    "/coach_team/getAllTeamsByLeagueSeason/:userId/:seasonId/:leagueId",
    controller.getAllTeamsByLeagueSeason
  );
