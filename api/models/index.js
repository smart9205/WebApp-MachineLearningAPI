...
db.verificationToken = require("../models/verificationtoken.js")(
  sequelize,
  Sequelize
);
db.subscription = require("../models/subscription.js")(sequelize, Sequelize);
db.user_subscription = require("../models/user_subscription.js")(
  sequelize,
  Sequelize
);
...
db.player_position = require("../models/player_position.js")(
  sequelize,
  Sequelize
);
...
db.corrections = require("../models/corrections.js")(sequelize, Sequelize);
...
db.user_edits_folders = require("../models/user_edits_folder.js")(
  sequelize,
  Sequelize
);
